...
*BankApplicationsAPI* | [**getBankApplication**](docs/BankApplicationsAPI.md#getbankapplication) | **GET** /api/bank_applications/{client_id} | Get bank application
...
*BankApplicationsAPI* | [**updateBankApplication**](docs/BankApplicationsAPI.md#updatebankapplication) | **PATCH** /api/bank_applications/{client_id} | Update bank application
...
*OrganizationApplicationsAPI* | [**getOrganizationApplication**](docs/OrganizationApplicationsAPI.md#getorganizationapplication) | **GET** /api/organization_applications/{client_id} | Get organization application
...
*OrganizationApplicationsAPI* | [**updateOrganizationApplication**](docs/OrganizationApplicationsAPI.md#updateorganizationapplication) | **PATCH** /api/organization_applications/{client_id} | Update organization application
...
*UsersAPI* | [**updateUser**](docs/UsersAPI.md#updateuser) | **PATCH** /api/users/{user_guid} | Update User
...
## Documentation For Models
 ...
 - [GroupAuthorizationIdpModel](docs/GroupAuthorizationIdpModel.md)
 - [GroupAuthorizationListIdpModel](docs/GroupAuthorizationListIdpModel.md)
 - [GroupIdpModel](docs/GroupIdpModel.md)
 - [GroupListIdpModel](docs/GroupListIdpModel.md)
 - [PatchApplicationIdpModel](docs/PatchApplicationIdpModel.md)
 - [PatchUserIdpModel](docs/PatchUserIdpModel.md)
 ...
 - [PostUserIdpModel](docs/PostUserIdpModel.md)
 - [UserIdpModel](docs/UserIdpModel.md)
 - [UserListIdpModel](docs/UserListIdpModel.md)
