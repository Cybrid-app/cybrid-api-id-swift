...
@objc public class PostCustomerToken: NSObject, Codable, JSONEncodable {
    ...
    public var scopes: Set<Scopes>

    public init(customerGuid: String, scopes: Set<Scopes>) {
