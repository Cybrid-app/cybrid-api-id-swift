...
@objc public class ApplicationWithSecret: NSObject, Codable, JSONEncodable {

    public enum Scopes: String, Codable, CaseIterable, CaseIterableDefaultsLast {
    ...
    public init(name: String, clientId: String, scopes: [Scopes], createdAt: Date, updatedAt: Date? = nil, secret: String) {
        self.name = name
